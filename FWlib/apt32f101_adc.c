...
U8_T ADC12_Compare_statue(ADC12_NBRCMPx_TypeDef NBRCMPx_TypeDef , ADC12_NBRCMPx_HorL_TypeDef ADC12_NBRCMPx_HorL)
{
...
//CVx:VALUE=(0~14)
//ADC12_ADCINX:ADC12_ADCIN0~ADC12_ADCIN14
//ReturnValue:NONE
/*************************************************************/ 
void ADC12_ConversionChannel_Config(ADC12_InputSet_TypeDef ADC12_ADCINX,U8_T CVx)
{
	switch(ADC12_ADCINX)
	{
		...
		case 12:
			...
			break;
		case 13:
			GPIOA0->CONLR = (GPIOA0->CONLR&0XFFFFFFFF)  | 0x00000000;							//ADC13
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFFFFFFFF)  | 0x00000000;	
			GPIOB0->CONLR = (GPIOB0->CONLR&0XFFFFFFFF)  | 0x00000000;		
			GPIOC0->CONLR = (GPIOC0->CONLR&0XFFFF0FFF)  | 0x0000A000;	
			break;
		case 14:
			GPIOA0->CONLR = (GPIOA0->CONLR&0XFFFFFFFF)  | 0x00000000;							//ADC14
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFFFFFFFF)  | 0x00000000;	
			GPIOB0->CONLR = (GPIOB0->CONLR&0XFFFFFFFF)  | 0x00000000;	
			GPIOC0->CONLR = (GPIOC0->CONLR&0XFFFFF0FF)  | 0x00000A00;
			break;	
	}
    ADC->CMR[0]=0;
    ADC->CMR[1]=0;	
