...
//EXI0_INT= EXI0,EXI1_INT= EXI1, EXI2_INT=EXI2~EXI3, EXI3_INT=EXI4~EXI8, EXI4_INT=EXI9~EXI13    
    ...
    GPIO_EXTI_interrupt(GPIOA0,0b00000000100000);				  //enable GPIOA05 as EXI
...
void COUNTA_CONFIG(void)
{
    ...
    COUNTA_IO_Init(2);                                                                    //set PA0.07 as counter IO
...
//------------  WDT FUNTION  --------------------------------/
    SYSCON_IWDCNT_Config(DISABLE_IWDT_SHORT,IWDT_TIME_128MS,IWDT_INTW_DIV_7);      //WDT TIME 1s,WDT alarm interrupt time=1s-1s*1/8=0.875S
    //SYSCON_WDT_CMD(ENABLE);                                                  //enable WDT		
    //SYSCON_IWDCNT_Reload();                                                   //reload WDT
	IWDT_Int_Enable();														//Enable WDT INT
	SYSCON_WakeUp_Enable();													//Enable WDT wakeup INT
//------------  LVD FUNTION  --------------------------------/ 
    SYSCON_LVD_Config(ENABLE_LVDEN,INTDET_LVL_3_0V,RSTDET_LVL_2_2V,ENABLE_LVD_INT);   //LVD LVR Enable/Disable
    //LVD_Int_Enable();
} 
/*********************************************************************************/  
/*********************************************************************************/
